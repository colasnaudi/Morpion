...
void afficherTableau (char tab, unsigned short int NB_CASES);
...
int main (void)
{
    ...
    cout << endl;
    cout << "Entrez la dimension du morpion (3 pour un 3x3) : ";
    cin >> NB_CASES;
    ...
    while (true)
    {
        char tab[NB_CASES][NB_CASES];
        //Initialiser le tableau
        for (int i = 0; i <= NB_CASES; i++)
        {
            for (int j = 0; j <= NB_CASES; i++)
            {
                tab[i][j] = ' ';
            }
